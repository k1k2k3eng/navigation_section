...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  casadi_int i, j, k;
  casadi_real *rr, *w01=w+14, *w03=w+20, *w04=w+24, w05, w06, w07, w08, w09, w10, w11, *w12=w+35;
  casadi_real *w13=w+39, *w14=w+43, *w15=w+47, *w16=w+51, *w17=w+67, *w18=w+76, *w19=w+85, *w20=w+88, w21, w22, w23, w24;
  casadi_real w25, w26, w27, w28, w29, *w30=w+100, *w31=w+103;
  ...
  w05 = 0.;
  /* #5: @1 = input[2][1] */
  casadi_copy(arg[2] ? arg[2]+1 : 0, 3, w01);
  /* #6: @6 = @1[0] */
  ...
  *rr++ = w05;
  ...
  /* #23: @4 = mac(@16,@3,@4) */
  for (i=0, rr=w04; i<1; ++i) for (j=0; j<4; ++j, ++rr) for (k=0, cs=w16+j, ct=w03+i*4; k<4; ++k) *rr += cs[k*4]**ct++;
  /* #24: @12 = input[0][2] */
  casadi_copy(arg[0] ? arg[0]+6 : 0, 4, w12);
  /* #25: @10 = @12[1] */
  for (rr=(&w10), cs=w12+1; cs!=w12+2; cs+=1) *rr++ = *cs;
  /* #26: @17 = zeros(3x3) */
  casadi_clear(w17, 9);
  /* #27: @8 = input[2][0] */
  w08 = arg[2] ? arg[2][0] : 0;
  ...
  *rr++ = w08;
  /* #29: @1 = @1' */
  /* #30: @17 = mac(@2,@1,@17) */
  for (i=0, rr=w17; i<3; ++i) for (j=0; j<3; ++j, ++rr) for (k=0, cs=wr02+j, ct=w01+i*1; k<1; ++k) *rr += cs[k*3]**ct++;
  /* #31: @18 = @17' */
  for (i=0, rr=w18, cs=w17; i<3; ++i) for (j=0; j<3; ++j) rr[i+j*3] = *cs++;
  /* #32: {@1, @19, @20} = horzsplit(@18) */
  casadi_copy(w18, 3, w01);
  ...
  w11 -= w23;
  /* #46: @23 = @12[3] */
  for (rr=(&w23), cs=w12+3; cs!=w12+4; cs+=1) *rr++ = *cs;
  /* #47: @9 = (2.*@9) */
  w09 = (2.* w09 );
  /* #48: @24 = (@23*@9) */
  w24  = (w23*w09);
  ...
  w11 -= w27;
  /* #58: (@4[0] += @11) */
  for (rr=w04+0, cs=(&w11); rr!=w04+1; rr+=1) *rr += *cs++;
  /* #59: @11 = (2.*@10) */
  w11 = (2.* w10 );
  /* #60: @7 = (-@7) */
  w07 = (- w07 );
  ...
  w27  = (w11*w07);
  /* #63: @28 = @12[0] */
  for (rr=(&w28), cs=w12+0; cs!=w12+1; cs+=1) *rr++ = *cs;
  /* #64: @29 = (@28*@8) */
  w29  = (w28*w08);
  /* #65: @27 = (@27+@29) */
  w27 += w29;
  ...
  w27 += w11;
  /* #80: (@4[1] += @27) */
  for (rr=w04+1, cs=(&w27); rr!=w04+2; rr+=1) *rr += *cs++;
  /* #81: @27 = (@6*@8) */
  w27  = (w06*w08);
  /* #82: @11 = (@10*@5) */
  w11  = (w10*w05);
  ...
  w27 += w11;
  /* #99: (@4[3] += @27) */
  for (rr=w04+3, cs=(&w27); rr!=w04+4; rr+=1) *rr += *cs++;
  /* #100: @27 = (2.*@6) */
  w27 = (2.* w06 );
  /* #101: @7 = (@27*@7) */
  w07  = (w27*w07);
  ...
  w07 += w27;
  /* #116: (@4[2] += @7) */
  for (rr=w04+2, cs=(&w07); rr!=w04+3; rr+=1) *rr += *cs++;
  /* #117: output[0][1] = @4 */
  if (res[0]) casadi_copy(w04, 4, res[0]+3);
  /* #118: @1 = zeros(3x1) */
  casadi_clear(w01, 3);
  /* #119: @7 = 1 */
  w07 = 1.;
  ...
  *rr++ = w07;
  ...
  for (i=0, rr=w19; i<1; ++i) for (j=0; j<3; ++j, ++rr) for (k=0, cs=w18+j, ct=wr02+i*3; k<3; ++k) *rr += cs[k*3]**ct++;
  /* #158: {NULL, NULL, @5} = vertsplit(@19) */
  w05 = w19[2];
  /* #159: output[0][2] = @5 */
  if (res[0]) res[0][7] = w05;
  /* #160: @16 = zeros(4x4) */
  casadi_clear(w16, 16);
  /* #161: @12 = @12' */
  /* #162: @16 = mac(@3,@12,@16) */
  for (i=0, rr=w16; i<4; ++i) for (j=0; j<4; ++j, ++rr) for (k=0, cs=w03+j, ct=w12+i*1; k<1; ++k) *rr += cs[k*4]**ct++;
  /* #163: @31 = @16' */
  for (i=0, rr=w31, cs=w16; i<4; ++i) for (j=0; j<4; ++j) rr[i+j*4] = *cs++;
  /* #164: {@3, @12, @4, @13} = horzsplit(@31) */
  casadi_copy(w31, 4, w03);
  casadi_copy(w31+4, 4, w12);
  casadi_copy(w31+8, 4, w04);
  ...
  /* #169: (@1[1] += @6) */
  for (rr=w01+1, cs=(&w06); rr!=w01+2; rr+=1) *rr += *cs++;
  /* #170: (@1[2] += @5) */
  ...
  w06 = (- w06 );
  /* #175: (@1[2] += @6) */
  for (rr=w01+2, cs=(&w06); rr!=w01+3; rr+=1) *rr += *cs++;
  /* #176: (@1[1] += @5) */
  ...
  for (rr=w01+0, cs=(&w05); rr!=w01+1; rr+=1) *rr += *cs++;
  /* #191: output[0][3] = @1 */
  if (res[0]) casadi_copy(w01, 3, res[0]+8);
  return 0;
}
