...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'launch'), glob(os.path.join('px4_mpc', 'launch', '*launch.[pxy][yma]*'))),
        (os.path.join('share', package_name, 'config'), glob(os.path.join('px4_mpc', 'config', '*.rviz'))),
    ],
    ...
    entry_points={
        'console_scripts': [
                ...
                'rviz_visualizer = px4_mpc.rviz_visualizer:main',
        ],
    },
)
